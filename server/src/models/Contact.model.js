...
//         urgency: { type: String, default: '' },
//         budget: { type: String, default: '' },
//         interest: { type: String, default: '' },     // hot / warm / cold
//         summary: { type: String, default: '' },     // AI এর সারসংক্ষেপ
//         score: { type: Number, default: 0 },
//         analyzedAt: { type: Date },                   // শেষ কবে analyze হয়েছে
//     },
...
const ContactSchema = new mongoose.Schema({
    ...
    // Client এর custom CRM column এর value (AI/manual ভরবে)
