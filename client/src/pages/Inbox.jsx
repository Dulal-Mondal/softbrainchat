...
//         try {
//             const res = await api.get('/conversations', { params: { platform, search } });
...
//                                                     {m.from === 'ai' ? '🤖 AI' : `👤 ${m.repliedBy}`} · {timeAgo(m.createdAt)}
//                                                 </div>
//                                             )}
//                                         </div>
//                                     </div>
...
//                 {active && contact && (
//                     <div style={{ width: 280, borderLeft: '1px solid var(--border)', padding: 20, background: 'var(--bg-secondary)' }}>
//                         <div style={{ textAlign: 'center', marginBottom: 20 }}>
//                             {contact.profilePic ? (
//                                 <img src={contact.profilePic} style={{ width: 70, height: 70, borderRadius: '50%', objectFit: 'cover', marginBottom: 10 }} />
//                             ) : (
//                                 <div style={{ width: 70, height: 70, borderRadius: '50%', background: 'var(--accent-dim)', color: 'var(--accent-2)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 26, fontWeight: 600, margin: '0 auto 10px' }}>
//                                     {contact.name?.[0]?.toUpperCase()}
//                                 </div>
//                             )}
//                             <div style={{ fontSize: 16, fontWeight: 600 }}>{contact.name}</div>
//                             <div style={{ fontSize: 12, color: 'var(--text-3)', marginTop: 3 }}>{PLATFORMS.find(p => p.key === contact.platform)?.label}</div>
//                         </div>

//                         <div style={{ borderTop: '1px solid var(--border)', paddingTop: 16 }}>
//                             <div style={{ fontSize: 13, fontWeight: 600, marginBottom: 12 }}>Contact details</div>
//                             {contact.phone && (
//                                 <div style={{ fontSize: 13, marginBottom: 8 }}>
//                                     <span style={{ color: 'var(--text-3)' }}>📞 Phone: </span>{contact.phone}
//                                 </div>
//                             )}
//                             <div style={{ fontSize: 13, marginBottom: 8 }}>
//                                 <span style={{ color: 'var(--text-3)' }}>🆔 ID: </span>
//                                 <span style={{ fontSize: 11, wordBreak: 'break-all' }}>{contact.senderId}</span>
//                             </div>
//                             <div style={{ fontSize: 13 }}>
//                                 <span style={{ color: 'var(--text-3)' }}>Platform: </span>{contact.platform}
//                             </div>
//                         </div>
//                     </div>
//                 )}
