...
const PLANS = [
    { id: 'free', label: 'Free', price: '$0', desc: '100 msg/month\nBasic AI chat only', color: 'var(--border)' },
    { id: 'pro', label: 'Pro', price: '$29', desc: '5,000 msg/month\nMeta Auto-Reply included', color: 'var(--accent)' },
    { id: 'pro-max', label: 'Pro Max', price: '$79', desc: 'Unlimited messages\nAll features unlocked', color: 'var(--purple)' },
];
...
export default function Register() {
    ...
    const afterRegister = () => {
        if (plan === 'free') navigate('/dashboard');
        else navigate(`/billing?plan=${plan}`);
    };
